 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://esame_giugno_server.mycompany.com/", wsdlLocation = "http://localhost:8080/Service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://esame_giugno_server.mycompany.com/", "ServiceImplService");
    ...
    public ServiceInterface getServiceImplPort() {
        return super.getPort(new QName("http://esame_giugno_server.mycompany.com/", "ServiceImplPort"), ServiceInterface.class);
    }
    ...
    public ServiceInterface getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://esame_giugno_server.mycompany.com/", "ServiceImplPort"), ServiceInterface.class, features);
    }
