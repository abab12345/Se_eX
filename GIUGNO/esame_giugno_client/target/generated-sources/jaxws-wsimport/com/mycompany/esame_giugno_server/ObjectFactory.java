 ...
 * generated in the com.mycompany.esame_giugno_server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetDetails_QNAME = new QName("http://esame_giugno_server.mycompany.com/", "getDetails");
    private final static QName _GetDetailsResponse_QNAME = new QName("http://esame_giugno_server.mycompany.com/", "getDetailsResponse");
    private final static QName _Professor_QNAME = new QName("http://esame_giugno_server.mycompany.com/", "Professor");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.esame_giugno_server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://esame_giugno_server.mycompany.com/", name = "getDetails")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://esame_giugno_server.mycompany.com/", name = "getDetailsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://esame_giugno_server.mycompany.com/", name = "Professor")
